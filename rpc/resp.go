...
type StatusInfo struct {
	...
	Files           []string `json:"files"`           // Returns the list of files. The elements of this list are the same structs used in aria2.getFiles() method.
	BitTorrent      struct {
...
type FileInfo struct {
	...
	URIs            []string `json:"uris"`      // Returns a list of URIs for this file. The element type is the same struct used in the aria2.getUris() method.
}
